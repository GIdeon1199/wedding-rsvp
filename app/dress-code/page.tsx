        ...
        <div className="max-w-4xl mx-auto">
              ...
              <Reveal key={a.title} delay={i * 0.15}>
                <div className="bg-white rounded-2xl p-8 border border-cream-300/50 card-hover">
                  ...
                  <ul className="space-y-3">
                    {a.items.map((item) => (
                      <li key={item} className="flex items-start gap-3 font-sans text-sm text-navy-500/60">
          ...
          <Reveal delay={0.1}>
            <div className="rounded-2xl p-8 border border-cream-300/50" style={{ background: "#FDFAF5" }}>
              ...
              <ul className="space-y-3">
                {avoid.map((item) => (
                  <li key={item} className="flex items-start gap-3 font-sans text-sm text-navy-500/55">
