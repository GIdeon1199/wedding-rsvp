          ...
          <div className="bg-white rounded-3xl p-8 sm:p-14 shadow-sm border border-cream-300/60 relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-8">
              ...
              <div className="flow-root">
                <div className="float-right ml-4 mb-4 relative w-24 h-24 sm:w-36 sm:h-36 rounded-full overflow-hidden border-2 border-gold-400 shadow-sm">
                  <Image
                    src="/story1.jpg"
                    alt="Beryl"
                    fill
                ...
                <h2 className="font-display text-3xl sm:text-4xl text-navy-500 mb-6 pb-2 border-b border-gold-400/10">
                  Beryl&apos;s POV
                </h2>
                <div className="font-sans text-navy-500/75 leading-loose text-[15px]">
                  <p className="mb-6">
